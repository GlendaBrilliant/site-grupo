...
|---|---|
| Glenda Lopes Brandão Oliveira | Estrutura HTML |
| Felipe de Moura Caitano | Estilo CSS e seção de membros |
| Alex Sander José Gomes Bonafé | Documentação e README |

---

## 💻 Sobre o Projeto

Site estático de apresentação do grupo, desenvolvido em HTML e CSS puro.
Criado com foco nas boas práticas de versionamento com Git e GitHub.

---

## 📁 Estrutura de Pastas
/src        → arquivos HTML e CSS do site
/docs       → documentação adicional do projeto
README.md   → apresentação e estratégia do projeto
...
O grupo adotou versionamento incremental com commits semânticos:
